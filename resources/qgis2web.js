...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31982',
            //extent: [135891.359375, 7044828.500000, 799876.625000, 7509602.500000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([353921.391162, 7256465.300000, 396934.952588, 7279930.700000], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGis de Mato Rico - PR</h2>';
        return titleElement;
    })(),
